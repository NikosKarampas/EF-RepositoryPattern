namespace RepositoryPattern.Migrations
{
    ...
    internal sealed class Configuration : DbMigrationsConfiguration<RepositoryPattern.Persistence.PlutoContext>
    {
        ...
        protected override void Seed(RepositoryPattern.Persistence.PlutoContext context)
        {
            #region Add Tags
